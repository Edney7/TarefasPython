...
def adicionar_tarefa():
    ...
    if tarefa and tarefa != "Escreva sua tarefa aqui":
        ...
        messagebox.showwarning("Opção inválida", "Por favor, insira uma tarefa")
...
def adicionar_item_tarefa(tarefa):
    ...
    btn_editar = tk.Button(frame_tarefa, image=icon_editar, command=lambda f=frame_tarefa, l=label_tarefa: preparar_edicao(f,l),bg="white", relief=tk.FLAT)
    btn_editar.pack(side=tk.RIGHT, padx=5)

    btn_deletar = tk.Button(frame_tarefa, image=icon_deletar, command=lambda f=frame_tarefa: deletar_tarefa(f),bg="white", relief=tk.FLAT)
...
icon_editar = PhotoImage(file="C:/Users/ednei/OneDrive/Área de Trabalho/Python/App Tarefas/editar.png").subsample(25,25)
icon_deletar = PhotoImage(file="C:/Users/ednei/OneDrive/Área de Trabalho/Python/App Tarefas/deletar.png").subsample(25,25)
fonte_cabecalho = font.Font(family="Garawond", size=24, weight="bold")
...
btn_add = tk.Button(frame, command=adicionar_tarefa, text="Adicionar Tarefa", bg="#4CAF50", fg="white", height=1, width=15, font=("Roboto",11), relief=tk.FLAT)
btn_add.pack(side=tk.LEFT, padx=10)

# Criando frame para a lista de tarefas com rolagem
